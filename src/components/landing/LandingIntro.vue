<template>
  <div class="max-w-[1200px] mx-auto px-6 md:-mt-12">
    <div class="w-full bg-light/25 rounded-2xl md:ounded-4xl">
      <div class="flex flex-col lg:flex-row lg:justify-between lg:space-x-24 max-w-[1400px] px-4 md:px-6 lg:px-24 py-16 lg:py-24 mx-auto">
        <div class="flex-shrink-0">
          <img src="/images/logo.png" alt="Poliklinika Eleos logo small" class="h-44 md:h-52 mx-auto" />
        </div>
